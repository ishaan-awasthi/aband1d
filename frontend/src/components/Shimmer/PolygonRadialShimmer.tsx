...
// interface PolygonRadialShimmerProps {
...
// const PolygonRadialShimmer: React.FC<PolygonRadialShimmerProps> = ({
//   polygon,
//   map,
//   color = DEFAULT_COLOR,
...
//         <defs>
//           <radialGradient id="radial-shimmer" cx={cx} cy={cy} r={r} gradientUnits="userSpaceOnUse">
...
// export default PolygonRadialShimmer; 